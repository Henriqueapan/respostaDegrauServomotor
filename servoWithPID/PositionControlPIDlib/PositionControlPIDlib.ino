...
double kp = 0.024075 , ki = 0.00852 , kd = 0.01701;            // modify for optimal performance
...
//   TCCR1B = TCCR1B & 0b11111000 | 1;
  ...
  myPID.SetOutputLimits(-254, 254); // this is the MAX PWM value to move motor, here change in value reflect change in speed of motor.
